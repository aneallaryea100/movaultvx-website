...
export default function Home() {
  ...
  return (
    <div>
      {/* Hero */}
      <section className="bg-gradient-to-br from-indigo-50 via-white to-emerald-50 py-24 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              to="/features"
              className="px-6 py-3 rounded-xl border border-gray-300 text-gray-700 font-semibold text-base hover:border-indigo-400 hover:text-indigo-700 transition-colors"
            >
              See All Features
            </Link>
          </div>
